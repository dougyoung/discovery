...
abstract class TweetSet {
  ...
  /**
    * Returns whether this TweetSweet contains elements, or not.
    */
  def isEmpty: Boolean
...
object GoogleVsApple {
  ...
  def filterTweets(wordList: List[String]): TweetSet =
    allTweets.filter(t => wordList.exists(s => t.text.contains(s)))
